...
; Generated by Chris Woodhouse on 06/11/2020 (UTC)
;
[Setup]
AppID={{9bbecaf5-6a2b-46d2-8f23-bd1f76a07511}
AppName=ASCOM RelayPwr Switch Driver
AppVerName=ASCOM RelayPwr Switch Driver 2.1
AppVersion=2.1
...
OutputDir="."
OutputBaseFilename="RelayPwr Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\RelayPwr"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\RelayPwr"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.RelayPwr.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.RelayPwr.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.RelayPwr.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.RelayPwr.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.RelayPwr.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
